...
**Purpose:** A portfolio project demonstrating demand analytics and the
...
rates exceeding over 30% compared to under 10% in São Paulo.
![Late delivery rate by state](q1_regional.png)

**2. Peak campaign → service degradation**  
Order volume spiked around 3× during Black Friday 2017. The average delivery time 
increased by 1-3 days during the peak days, and the late delivery rate jumped from 6.9% to 23.2% in the week following the peak.
...
Orders arriving 7+ days late average 1.72 stars which is a 2.42 point drop compared to on-time orders, which directly impacts seller ratings and repeat purchase rates.
...
noon, is not the constraint but seller first-mile SLA compliance is. 
